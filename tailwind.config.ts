  ...
  theme: {
    extend: {
      colors: {
        ...
        'chat-wallpaper': 'rgb(var(--color-chat-wallpaper) / <alpha-value>)',
        'chat-time':      'rgb(var(--color-chat-time) / <alpha-value>)',
        'chat-time-mine': 'rgb(var(--color-chat-time-mine) / <alpha-value>)',
      ...
      spacing: {
        ...
        ring:       'var(--space-ring)',
        'bubble-gap': 'var(--space-bubble-gap)',
        dot:          'var(--size-dot)',
        'run-gap':    'var(--space-run-gap)',
