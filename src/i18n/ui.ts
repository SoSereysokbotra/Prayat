...
const strings = {
  ...
  nextModule: { kh: 'មេរៀនបន្ទាប់', en: 'NEXT MODULE' },
  ruleToRemember: { kh: 'ច្បាប់ដែលត្រូវចាំ', en: 'Rule to remember' },
  toolUnlockedNamed: { kh: 'ទទួលបាន {tool}', en: '{tool} unlocked' },

  /* ---- module 1: the network ---- */
  networkTitle: { kh: 'បណ្ដាញ', en: 'The Network' },
  networkConcept: {
    kh: 'Wi-Fi សាធារណៈ ផ្ញើទិន្នន័យអ្នកដូចកាតប៉ុស្តាល់បើកចំហ — អ្នកនៅក្បែរអាចអានបាន។ HTTPS ប្រែវាទៅជាប្រអប់ចាក់សោ។',
  ...
  coffeeShopHint: {
    kh: 'ចុច ការពារ មុនពេលទិន្នន័យអ្នកទៅដល់ជនចម្លែក',
  ...
  tapToShield: { kh: 'ចុចដើម្បីការពារ', en: 'TAP TO SHIELD' },
  secured: { kh: 'បានការពារ', en: 'Secured' },
  strangerBlocked: { kh: 'ត្រូវបានរារាំង!', en: 'Blocked!' },
  strangerRead: { kh: 'គេអានបានហើយ!', en: 'Read it!' },
  coffeeShopPassed: { kh: 'ទិន្នន័យទាំងអស់ត្រូវបានការពារ', en: 'All data protected' },
  coffeeShopPassedSub: {
    kh: 'ជនចម្លែកត្រូវបានរារាំង {n} ដងក្នុងចំណោម {total}',
    en: 'Stranger blocked {n} of {total} times',
  },
  coffeeShopFailed: {
    kh: 'ជនចម្លែកអានកាតប៉ុស្តាល់បាន {n}។ ត្រូវការពារយ៉ាងហោច {pass} ក្នុងចំណោម {total}។',
    en: 'The stranger read {n} postcards. Protect at least {pass} of {total}.',
  },
  networkRule: {
    kh: 'ពិនិត្យរក 🔒 ក្នុងកម្មវិធីរុករកជានិច្ច។ កុំចូលគណនីធនាគារលើ Wi-Fi សាធារណៈដោយគ្មាន VPN ឡើយ។',
    en: 'Always check for 🔒 in your browser. Never log into your bank on public Wi-Fi without a VPN.',
  },
  shieldBadgeUnlocked: { kh: 'ទទួលបានផ្លាកសញ្ញាការពារ', en: 'Shield Badge unlocked' },
  ...
  /* ---- vip club ---- */
  doorTitle: { kh: 'ទ្វារ', en: 'The Door' },
  doorConcept: {
    kh: 'លេខសម្ងាត់គ្រាន់តែជាពាក្យមួយ — អ្នកណាក៏អាចទាយបាន។ 2FA បន្ថែមកូដដែលផ្ញើទៅតែទូរស័ព្ទពិតរបស់អ្នក។ អ្នកបោកមិនអាចយកកូដនោះបានទេ។',
  ...
  vipClubHint: {
    kh: 'អ្នកជាអ្នកយាមទ្វារ។ ឲ្យមនុស្សត្រឹមត្រូវចូល។ រារាំងអ្នកណាដែលគ្មានកូដ 2FA។',
    en: 'You are the bouncer. Let the right people in. Block anyone without the 2FA code.',
  },
  roundN: { kh: 'ជុំទី {n}', en: 'Round {n}' },
  phoneNoCode: { kh: 'គ្មានកូដ — លេខសម្ងាត់តែប៉ុណ្ណោះ', en: 'No code — password only' },
  phoneCodeSent: { kh: 'កូដផ្ញើទៅទូរស័ព្ទសមាជិកពិត', en: 'Code sent to the member’s real phone' },
  roundRealUser: { kh: 'ជុំទី {n}៖ សមាជិកពិត', en: 'Round {n}: Real user' },
  roundScammer: { kh: 'ជុំទី {n}៖ អ្នកបោក', en: 'Round {n}: Scammer' },
  codeLabel: { kh: 'កូដ 2FA៖', en: '2FA code:' },
  noCodeShown: { kh: 'គ្មានកូដបង្ហាញ', en: 'No code shown' },
  visitorForgotPhone: { kh: '«ខ្ញុំភ្លេចទូរស័ព្ទ…»', en: '“I forgot my phone…”' },
  visitorPhoneDied: { kh: '«ទូរស័ព្ទខ្ញុំអស់ថ្ម — អ្នកគ្រប់គ្រងស្គាល់ខ្ញុំ លឿនឡើង!»', en: '“My phone died — the manager knows me, hurry up!”' },
  letIn: { kh: 'ឲ្យចូល', en: 'LET IN' },
  block: { kh: 'រារាំង', en: 'BLOCK' },
  doorRightIn: { kh: 'ត្រូវហើយ — លេខសម្ងាត់ និងកូដ គឺជាសមាជិកពិត។', en: 'Right — password and code. That is a member.' },
  doorRightBlock: { kh: 'ត្រូវហើយ — លេខសម្ងាត់តែម្នាក់ឯង មិនបញ្ជាក់អ្វីទេ។', en: 'Right — a password alone proves nothing.' },
  doorWrongIn: { kh: 'គាត់គ្មានកូដ។ លេខសម្ងាត់ដែលបានលួច មើលទៅដូចលេខសម្ងាត់ពិត — អ្នកទើបឲ្យអ្នកបោកចូល។', en: 'He had no code. A stolen password looks exactly like the real one — you just let a scammer in.' },
  doorWrongBlock: { kh: 'គាត់មានកូដ។ កូដទៅដល់តែទូរស័ព្ទសមាជិកពិតប៉ុណ្ណោះ — នោះជាភស្តុតាង។', en: 'They had the code. The code only reaches the real member’s phone — that is the proof.' },
  mistakes: { kh: 'កំហុស', en: 'Mistakes' },
  doorReset: { kh: 'ខុសពីរដង — ទ្វារចាប់ផ្ដើមឡើងវិញ។', en: 'Two wrong calls — the door resets.' },
  vipClubPassed: { kh: 'អ្នកបោកត្រូវបានរារាំង', en: 'Scammer blocked' },
  vipClubPassedSub: { kh: 'ទ្វារបានបិទ ព្រោះគាត់គ្មានកូដ', en: 'The door stayed shut because he had no code' },
  vipClubFailed: { kh: 'អ្នកបោកបានចូល។ សាកម្តងទៀត ហើយសុំកូដនៅពេល 2FA បើក។', en: 'The scammer got in. Try again, and ask for the code once 2FA is on.' },
  vipClubTimeUp: { kh: 'អស់ពេល។ អ្នកយាមទ្វារត្រូវសម្រេចចិត្តឲ្យលឿន។', en: 'Time is up. A bouncer has to decide quickly.' },
  doorRule: {
    kh: 'បើក 2FA លើ ABA, Wing, Telegram និង Facebook។ កុំចែករំលែកកូដ 2FA របស់អ្នកទៅនរណាម្នាក់ដែលសុំវាឡើយ។',
    en: 'Enable 2FA on ABA, Wing, Telegram, and Facebook. Never share your 2FA code with anyone who asks for it.',
  },
  authTokenUnlocked: { kh: 'ទទួលបានលេខសម្ងាត់បញ្ជាក់', en: 'Authenticator Token unlocked' },
  ...
  /* ---- url sorter ---- */
  mapTitle: { kh: 'ផែនទី', en: 'The Map' },
  mapConcept: {
    kh: 'អ្នកបោកបង្កើតអាសយដ្ឋានវេបសាយក្លែងក្លាយដែលមើលទៅស្ទើរតែដូចពិត។ អានឈ្មោះដែនបញ្ច្រាសពី .com ឬ .kh ដើម្បីដឹងថាអ្នកណាជាម្ចាស់ពិត។',
  ...
  urlSorter: { kh: 'តម្រៀបអាសយដ្ឋាន', en: 'THE URL SORTER' },
  urlSorterHint: { kh: 'អាសយដ្ឋានធ្លាក់ពីលើ។ តម្រៀបនីមួយៗមុនវាធ្លាក់ដល់បាត។', en: 'URLs fall from above. Sort each one before it hits the bottom.' },
  activeUrl: { kh: 'អាសយដ្ឋានបច្ចុប្បន្ន', en: 'Active URL' },
  ownerIs: { kh: 'ម្ចាស់៖ {owner}', en: 'Owner: {owner}' },
  urlMissed: { kh: 'ធ្លាក់ដល់បាត — រាប់ជាខុស', en: 'Hit the bottom — counts as wrong' },
  urlSorterPassed: { kh: 'តម្រៀបត្រូវ {n} ក្នុងចំណោម {total}', en: '{n} of {total} sorted correctly' },
  urlSorterFailedScore: { kh: 'ត្រូវតែ {n} ក្នុងចំណោម {total}។ ត្រូវការ {pass}។ សាកម្តងទៀត។', en: 'Only {n} of {total}. You need {pass}. Try again.' },
  urlSorterReset: { kh: 'ខុសបីដង — តម្រៀបចាប់ផ្ដើមឡើងវិញ។', en: 'Three wrong — the sorter resets.' },
  mapRule: { kh: 'ពាក្យដែលនៅមុន .com ឬ .kh ភ្លាមៗ គឺជាម្ចាស់ពិត។', en: 'The word just before .com or .kh is the real owner.' },
  magnifierUnlocked: { kh: 'ទទួលបានកញ្ចក់ពង្រីក', en: 'Magnifying Glass unlocked' },
  magnifierUse: { kh: 'ប្រើវាក្នុងរបៀបស៊ើបអង្កេត ដើម្បីពង្រីកមើលអាសយដ្ឋាន។', en: 'Use it in Investigation Mode to zoom in on URLs.' },
  seeYourTools: { kh: 'មើលឧបករណ៍របស់អ្នក', en: 'SEE YOUR TOOLS' },

  /* ---- bootcamp complete ---- */
  trainingComplete: { kh: 'ការហ្វឹកហាត់បានបញ្ចប់', en: 'Training complete' },
  yourToolbelt: { kh: 'ខ្សែក្រវាត់ឧបករណ៍របស់អ្នក', en: 'Your toolbelt' },
  activeInInvestigation: { kh: 'ប្រើបានក្នុងរបៀបស៊ើបអង្កេត', en: 'Active in Investigation Mode' },
  youAreReady: { kh: 'អ្នកត្រៀមរួចហើយ។ សេណារីយ៉ូពិតចាប់ផ្ដើមឥឡូវនេះ។', en: 'You are ready. The real scenarios start now.' },
  enterScamSim: { kh: 'ចូលទៅ ScamSim', en: 'ENTER SCAMSIM' },
